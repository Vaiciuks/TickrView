...
function LegalModal({ title, onClose, children }) {
  return (
    <div className="contact-overlay" onClick={onClose}>
      <div className="contact-modal legal-modal" onClick={e => e.stopPropagation()}>
...
function PrivacyModal({ onClose }) {
  return (
    <LegalModal title="Privacy Policy" onClose={onClose}>
      ...
      <h3>Overview</h3>
      <p>
        TickrPulse is a financial data aggregation tool that displays publicly available
        market information. We are committed to protecting your privacy and being transparent
      ...
      <p>
        ...
        information you voluntarily provide (name, email, and message). This information
        is used solely to respond to your inquiry and is not shared with third parties.
      </p>
      <p>
        <strong>Server Logs:</strong> Our servers may automatically log standard request
        information (IP address, browser type, pages visited, timestamps) for security
        and maintenance purposes. These logs are not used for tracking or profiling and
      ...
      <ul>
        <li><strong>Right to Know:</strong> You may request what personal information we collect, use, or disclose.</li>
      ...
      <p>
        ...
        parties for monetary or other valuable consideration. We have not sold personal
      ...
      <p>
        TickrPulse is not directed at children under 13 (or 16 in the EEA). We do not
        knowingly collect information from children. If we become aware that we have
        collected data from a child, we will promptly delete it.
      </p>

      <h3>International Users</h3>
      <p>
        TickrPulse is operated from the United States. If you access the service from
      ...
      <p>
        ...
        by updating the date at the top of this policy. Continued use of the site after
      ...
      <p>
        ...
        rights, please reach out through our Contact form.
      </p>
    </LegalModal>
  );
}
...
function TermsModal({ onClose }) {
  return (
    <LegalModal title="Terms of Service & Disclaimer" onClose={onClose}>
      ...
      <p>
        By accessing and using TickrPulse, you agree to these terms. If you do not agree
        with any part of these terms, please discontinue use of the service.
      </p>

      <h3>Not Financial Advice</h3>
      <p>
        <strong>TickrPulse is for informational and educational purposes only.</strong> Nothing
        on this website constitutes financial advice, investment advice, trading advice,
        or any other form of professional advice. You should not make any investment decision
        based solely on information provided by TickrPulse. Always consult with a qualified
        financial advisor before making investment decisions.
      </p>

      <h3>Data Accuracy Disclaimer</h3>
      <p>
        Market data, stock quotes, charts, financial statistics, and other information
      ...
      <h3>No Warranty</h3>
      <p>
        TickrPulse is provided "as is" and "as available" without warranties of any kind,
      ...
      <p>
        To the maximum extent permitted by law, TickrPulse and its operators, directors,
        employees, and affiliates shall not be liable for any losses, damages, or costs
        arising from your use of or reliance on the information provided on this website.
        This includes, but is not limited to, any direct, indirect, incidental, special,
        consequential, or punitive damages resulting from investment or trading decisions,
        loss of profits, data loss, or business interruption.
      </p>

      <h3>Indemnification</h3>
      <p>
        You agree to indemnify and hold harmless TickrPulse and its operators from any
        claims, losses, or damages (including legal fees) arising from your use of the
      ...
      <p>
        The TickrPulse name, logo, and website design are the property of TickrPulse.
        Market data and financial information displayed belong to their respective data
        providers and are subject to their terms of use.
      </p>

      <h3>Prohibited Use</h3>
      <p>
        You may not use TickrPulse to: systematically scrape, harvest, or redistribute
      ...
      <p>
        We reserve the right to modify these terms at any time. Continued use of TickrPulse
        after changes constitutes acceptance of the updated terms.
      </p>

      <h3>Contact</h3>
      <p>
        For questions about these terms, please reach out through our Contact form.
      </p>
    </LegalModal>
  );
}
...
function DoNotSellModal({ onClose }) {
  return (
    <LegalModal title="Do Not Sell My Personal Information" onClose={onClose}>
      ...
      <p>
        TickrPulse does not sell, rent, trade, or otherwise share your personal information
        with third parties for monetary or other valuable consideration. This has been our
        practice since launch and will remain so.
      </p>
      ...
      <div className="contact-modal" onClick={e => e.stopPropagation()}>
        ...
        {sent ? (
          <div className="contact-sent">
            ...
            <button className="contact-sent-btn" onClick={onClose}>Close</button>
          </div>
        ) : (
  ...
  return createPortal(
    <div className="consent-banner">
      <p className="consent-text">
        ...
        No tracking cookies are used. By continuing to use this site, you consent to our
        use of localStorage and agree to our <button className="consent-link" onClick={onOpenPrivacy}>Privacy Policy</button> and <button className="consent-link" onClick={onOpenTerms}>Terms of Service</button>.
        Data displayed is for informational purposes only and is not financial advice.
      </p>
      <button className="consent-accept" onClick={accept}>Accept & Continue</button>
    </div>,
    document.body
  );
}
      ...
      <footer className="app-footer">
        <div className="app-footer-inner">
          <div className="app-footer-links">
            ...
            <span className="app-footer-sep">&middot;</span>
            <button className="app-footer-link" onClick={() => setActiveModal('terms')}>Terms & Disclaimer</button>
            <span className="app-footer-sep">&middot;</span>
            <button className="app-footer-link" onClick={() => setActiveModal('donotsell')}>Do Not Sell My Personal Information</button>
          </div>
          <div className="app-footer-copy">
            Quotes delayed 15 min for NASDAQ, NYSE, and AMEX. Not financial advice.
          </div>
          <div className="app-footer-copy">
            &copy; {year} <span className="app-footer-brand">TickrPulse</span>. All rights reserved.
          </div>
        </div>
      </footer>
      <ConsentBanner onOpenPrivacy={() => setActiveModal('privacy')} onOpenTerms={() => setActiveModal('terms')} />
      {activeModal === 'contact' && createPortal(<ContactModal onClose={() => setActiveModal(null)} />, document.body)}
      {activeModal === 'privacy' && createPortal(<PrivacyModal onClose={() => setActiveModal(null)} />, document.body)}
      {activeModal === 'terms' && createPortal(<TermsModal onClose={() => setActiveModal(null)} />, document.body)}
      {activeModal === 'donotsell' && createPortal(<DoNotSellModal onClose={() => setActiveModal(null)} />, document.body)}
    </>
  );
}
