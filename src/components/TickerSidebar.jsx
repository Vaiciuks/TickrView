  ...
  return (
    ...
    >
      ...
      <div className="ticker-row-right">
        ...
        {stock.extPrice != null && (
          <span
            className={`ticker-row-ext-line ${extPositive ? "change-up" : "change-down"}`}
          >
...
export default function TickerSidebar({
  ...
  const startDrag = useCallback(
    (fromIndex, startX, startY, rowEl, isTouch = false) => {
      ...
      const clearOverClass = () => {
        listEl
          .querySelectorAll(
            ".ticker-row--dragover-above,.ticker-row--dragover-below",
          )
          .forEach((el) => {
            el.classList.remove(
              "ticker-row--dragover-above",
              "ticker-row--dragover-below",
            );
          });
      };
  ...
  return (
    <>
      <aside
        ref={sidebarRef}
        className={`ticker-sidebar ${isOpen ? "ticker-sidebar--open" : "ticker-sidebar--closed"}`}
      >
        <button
        ...
        <div className="ticker-sidebar-content">
          <div className="ticker-sidebar-header">
            <div className="ticker-sidebar-title-row">
              ...
              <div
                className="ticker-sidebar-search-wrapper"
                  ...
                  <ul className="ticker-sidebar-suggestions">
                    {suggestions.map((item, i) => (
                      ...
                      >
                        ...
                        <span className="ticker-sidebar-suggestion-symbol">
                          {item.symbol}
                        </span>
                        <span className="ticker-sidebar-suggestion-name">
                          {item.name}
                        </span>
                      </li>
                    ))}
          ...
          <div className="ticker-sidebar-tabs">
            ...
            >
              Recent
              {filteredRecent.length > 0 ? ` (${filteredRecent.length})` : ""}
            </button>
            <button
                ...
                {portfolio.length > 0 && (
                  <div className="pf-sidebar-summary">
                    ...
                    {(() => {
                      ...
                      return (
                        <span
                          className={`pf-sidebar-pl ${totalPL >= 0 ? "pf-up" : "pf-down"}`}
                        >
                          {totalPL >= 0 ? "+" : ""}
                ...
                {portfolio.map((h) => (
                  ...
                  >
                    ...
                    <div className="ticker-row-info">
                      ...
                      <span className="ticker-row-name">
                        {h.shares} shares @ {formatPrice(h.avgCost)}
                      </span>
                    </div>
                    <div className="ticker-row-right">
                      <span
                        className={`ticker-row-badge ${(h.pl || 0) >= 0 ? "badge-up" : "badge-down"}`}
                      >
                        {h.pl != null
                      ...
                      {h.price != null && (
                        <span
                          className={`ticker-row-ext-line ${h.changePercent >= 0 ? "change-up" : "change-down"}`}
                        >
                          {formatPrice(h.price)}
                        </span>
                      )}
